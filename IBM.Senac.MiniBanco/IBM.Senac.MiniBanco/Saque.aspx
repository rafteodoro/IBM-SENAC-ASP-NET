<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Saque.aspx.cs" Inherits="IBM.Senac.MiniBanco.Saque" %>
...
<body>
    <form id="form1" runat="server" style="display: inline-block">
        <asp:Label ID="Label1" runat="server" Font-Size="Larger" Text="Saque"></asp:Label>
        <p>
        ...
        <p>
            <asp:Button ID="ButtonSacar" runat="server" Text="Sacar" />
        </p>
    </form>
</body>
</html>
